/**
 * src/cli/export.js
 * Implementation of the "markfi export" command.
 *
 * Sub-commands / formats:
 *   markfi export images  [--pages 1,3-5] [--format png|jpg] [--dpi N] <project-dir|pdf>
 *   markfi export md      [--no-cover]    [--out path.md]              <project-dir>
 *
